    ...
    ui(new Ui::addEVeDlg)
{
	...
	connect(queding, &QPushButton::clicked, this,&addEVeDlg::on_1_clicked);
	connect(shanchu, &QPushButton::clicked, this, &addEVeDlg::on_2_clicked);
